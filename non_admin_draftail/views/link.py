from wagtail.admin.forms.choosers import ExternalLinkChooserForm, EmailLinkChooserForm, PhoneLinkChooserForm, \
...
def external_link(request):
    ...
    return render_modal_workflow(
        request,
        'non_admin_draftail/link/external_link.html', None,
...
def email_link(request):
    ...
    return render_modal_workflow(
        request,
        'non_admin_draftail/link/email_link.html', None,
        shared_context(request, {
            'form': form,
...
def phone_link(request):
    ...
    return render_modal_workflow(
        request,
        'non_admin_draftail/link/phone_link.html', None,
        shared_context(request, {
            'form': form,
...
def anchor_link(request):
    ...
    return render_modal_workflow(
        request,
        'non_admin_draftail/link/anchor_link.html', None,
        shared_context(request, {
            'form': form,
